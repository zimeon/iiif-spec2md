...
| `sha1` | Insecure. Use only for legacy fixity values. SHA-1 algorithm defined by [[!FIPS-180-4]]
...
| `sha512` | Default choice. Non-truncated form only. SHA-512 algorithm defined by [[!FIPS-180-4]] and
...
| `blake2b-512` | Full-length form only, using the 2B variant (64 bit) as defined by [[!RFC7693]].
                    ...
                    `blake2b-512` digest of a zero-length bitstream starts
